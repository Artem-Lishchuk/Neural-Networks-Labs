...
Inputs:
  - w: A torch tensor giving the current weights.
  - dw: A torch tensor of the same shape as w giving the gradient of the
...
def sgd_momentum(w, dw, config=None):
    ...
    - velocity: A torch tensor of the same shape as w and dw used to store a
...
def rmsprop(x, dx, config=None):
    ...
    config.setdefault('cache', torch.zeros_like(x))
...
def adam(x, dx, config=None):
    ...
    next_x = x - config['learning_rate'] * mt / (torch.sqrt(vt) + config['epsilon'])
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
